...
var (
	ErrSrvDraining = errors.New("service is draining")
)

type OnRecived func(origin any, name string, topic string, partition int, offset int64, properties map[string]string, message []byte)
